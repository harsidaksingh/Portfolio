    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description=" I understand client needs and goals, and gather insights to define project scope and requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description=" I create visual designs and develop responsive websites using the latest web technologies."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="I deploy the website and provide initial support while gathering client feedback for continuous improvement."
        >
          <CanvasRevealEffect
            animationSpeed={3}
